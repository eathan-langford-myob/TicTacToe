...
public class Rules {
    ...
    public static boolean checkDiagonalFromTopLeft(Board board) {
    ...
    public static boolean checkDiagonalFromTopRight(Board board) {
        Character[] oneDiagnonal = new Character[board.getBoard().length];
        boolean diagonalWin;
    ...
    public static boolean checkWinConditions(Board board) {
        return checkHorizontals(board) || checkVerticals(board) || checkDiagonalFromTopLeft(board) || checkDiagonalFromTopRight(board);
    }
}
